...
def train(args,device_id):
    ...
    tokenizer = RobertaTokenizer.from_pretrained('/home/Grey/Jupyter_Notebook/roberta-base')
    word_padding_idx = tokenizer.pad_token_id
    symbols = {'BOS': 0, 'EOS': 2, 'PAD': word_padding_idx}
    print(symbols)
...
def validate(args, device_id, pt, step):
    ...
    valid_iter = e_dataloader.GraphDataLoader(args, load_dataset_val(args, 'val', shuffle=False), symbols,
...
def test(args, pt, step):
    ...
    test_iter = e_dataloader.GraphDataLoader(args, load_dataset_val(args, 'test', shuffle=False), symbols,
